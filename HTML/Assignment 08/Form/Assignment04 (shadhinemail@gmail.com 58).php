			...
			<div style="margin-left: 50px">
				<form action="action_page.php">
					...
					<div style="display: inline; margin: 1px; width: 100%">
						<div  style="display: inline;max-width: 30%"><input type="radio" name="agree"> I agree to ShadhiN terms</div>
<div style="display: inline;width: 100%"><input  type="submit" value="Create an account"></div>
