		...
		<article>
			...
			<div style="margin-right:50px;margin-left:50px">
				<form method="post"  autocomplete="on" action="<?php echo htmlspecialchars($_SERVER[" PHP_SELF "]);?>">
					...
					<input type="text" id="fname" name="firstname" placeholder="First Name" maxlength="50" autofocus required>
					...
					<input type="email" id="fname" name="reemail" placeholder="Re-enter Email" required>
					<br>
					...
					<input type="password" id="fname" name="pass" placeholder="Password " required>
					<br>
					<!--<label for="fname">Re-type Password </label>-->
					<input type="password" id="fname" name="pass" placeholder="Re-type Password" required>
					<br>
