		...
		<article>
			...
			<div style="margin-right:50px;margin-left:50px">
				<form method="post" target="_blank" autocomplete="on" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
					...
					<span class="error">
						<?php echo $errors['Name11'];?>
					</span>
					<span class="error">
						<?php echo $errors['Name12'];?>
					</span>
					<span class="error">
						<?php echo $errors['Name13'];?>
					</span>
					...
					<span class="error">
						<?php echo $errors['Name21'];?>
					</span>
					<span class="error">
						<?php echo $errors['Name22'];?>
					</span>
					<span class="error">
						<?php echo $errors['Name23'];?>
					</span>
					...
					<span class="error" >
					<font size="2"><?php echo " ".$errors['gender'];?></font></p>
					</span>
					...
					<span class="error" >
					<font size="2"><?php echo " ".$errors['email'];?></font></p>
					</span>
					<!--<label for="lname">Phone Number</label>-->
					<input type="tel" id="lname" name="telphone" placeholder="Phone Number with Country Code"  required><br>
					<span class="error" >
					<font size="2"><?php echo " ".$errors['telphone1'];?></font></p>
					</span>
						<span class="error" >
					<font size="2"><?php echo " ".$errors['telphone2'];?></font></p>
					</span>
					...
					<br>
					<span class="error" >
					<font size="2"><?php echo " ".$errors['password11'];?></font></p>
					</span>
					</span>
						<span class="error" >
					<font size="2"><?php echo " ".$errors['password12'];?></font></p>
					</span>
					...
					<input type="password" id="fname" name="pass2" placeholder="Re-type Password"  required>
						...
						<span class="error" >
					<font size="2"><?php echo " ".$errors['password'];?></font></p>
					</span>
					</span>
						<span class="error" >
					<font size="2"><?php echo " ".$errors['password21'];?></font></p>
					</span>
					</span>
						<span class="error" >
					<font size="2"><?php echo " ".$errors['password22'];?></font></p>
					</span>
