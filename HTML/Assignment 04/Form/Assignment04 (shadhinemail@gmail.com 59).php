		...
		<article>
			...
			<div style="margin-left: 50px">
				<form action="action_page.php">
					...
					<input type="reset">
					<br><br>
					<div style="display: inline; margin: 1px; width: 100%;border: 1px solid black;">
						<div  style="display: inline;width: 30px"><input type="radio" name="agree"> I agree to ShadhiN terms</div>
<div style="display: inline;width: 70px;border: 5px solid black;"><input  type="submit" value="Create an account"></div>
