...
// email recheck
          ...
          $dbname = "shadhin";
          if($_POST){
              $pFull_name=filter_input(INPUT_POST, "firstname");
          $pNick_name=filter_input(INPUT_POST,"lastname");
          $pEmail=filter_input(INPUT_POST,"email22");
          $pGender=filter_input(INPUT_POST,"gender");
          $pPhone=filter_input(INPUT_POST,"telphone");
          $pBday=filter_input(INPUT_POST,"Birth_day");
          $pPass=filter_input(INPUT_POST,"pass2");
          }
     ...
     //$conn = mysqli_connect($servername, $username, $password,$dbname);
          ...
          $sql ="INSERT INTO register (Full_name, Nick_name, Gender,Email,Phone,Birthday,Password) VALUES ('A','B', 'C','D','E','F','F');";
