...
// email id duplicate checkdate
                ...
                {
                    window.alert("should be less then 8");
                    jpassword2.focus();
                    return false;
                }
        ...
        <div class="container">
            ...
            <article>
                ...
                <div style="margin-right:50px;margin-left:50px">
                    <form method="post" target="_self" autocomplete="on" onsubmit="return ValidateContactForm();" name="ContactForm" action="success.php">
                        <?php /* echo htmlspecialchars($_SERVER["a.php"]); */ ?>

                        <input type="text" id="Hfull_name" name="firstname" placeholder="Full Name (Character Min:2 Max:20)"  autofocus required  >
                        <input type="text" id="Hnick_name" name="lastname"  placeholder="Nick Name (Character Min:2 Max:20)" required>
                        ...
                        <input type="email" id="Hemail1" name="email11" placeholder="Email" required>

                        <input type="email" id="Hemail2" name="email22" placeholder="Re-enter Email" required>

                        <span class="error">
                            <font size="2">
                            <?php
                            if (isset($errors['emailechek02'])) {
                                echo $errors['emailechek02'];
                            }
                        ...
                        <input type="number" id="Htel" name="telphone"  placeholder="Phone Number with Country Code (Min:8 Max:20)" required><br>
