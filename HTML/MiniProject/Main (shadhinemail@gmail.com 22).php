...
// email recheck
          ...
          $password = "";
          $dbname = "shadhin";
          $pFull_name="<script>document.write(jfull_name)</script>";
          $pNick_name="<script>document.write(jnick_name)</script>";
          $pEmail="<script>document.write(jemail2)</script>";
          $pGender="<script>document.write(jgender)</script>";
          $pPhone="<script>document.write(jphone)</script>";
          $pBday="<script>document.write(jbirthday)</script>";
          $pPass="<script>document.write(jpassword2)</script>";
