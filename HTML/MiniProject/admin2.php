...
<!--			
 ...
 <li style="float:right"><a class="active" href="Assignment07.php">Login</a></li>
  <li style="float:right"><a class="active" href="Assignment07.php">Sign Up</a></li>
		...
		<article>
<?php 
session_start();if(isset($_SESSION['email22'])){
...
$sql = "SELECT register.Full_name,register.Nick_name,register.Gender,register.Email,register.Phone,register.Birthday,register.Password FROM register INNER JOIN admin where register.Email NOT IN (SELECT admin.Email FROM admin)";
