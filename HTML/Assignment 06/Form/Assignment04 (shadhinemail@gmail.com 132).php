	...
	<div class="container">
		...
		<article>
			...
			<div style="margin-right:50px;margin-left:50px">
				<form method="post" autocomplete="on" action="<?php echo htmlspecialchars($_SERVER["welcome.php"]);?>">
					...
					<input type="password" id="fname" name="pass1" placeholder="Password " min="2" max="20" required>
					<br>
					<!--<label for="fname">Re-type Password </label>-->
					<input type="password" id="fname" name="pass2" placeholder="Re-type Password" min="2" max="20" required>
					<span class="error" >
