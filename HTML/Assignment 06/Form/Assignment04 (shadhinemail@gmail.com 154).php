	...
	<div class="container">
		...
		<article>
			...
			<div style="margin-right:50px;margin-left:50px">
				<form method="post" target="_blank" autocomplete="on" action="<?php echo htmlspecialchars("oil.php");?>">
					...
					<input type="text" name="firstname" value="<?php if(isset($_POST['firstname'])) echo $_POST['firstname']; ?>" placeholder="First Name" autofocus required>
					...
					<input type="text" name="lastname" value="<?php if(isset($_POST['lastname'])) echo $_POST['lastname']; ?>" placeholder="Last Name"  required>
					...
					<input type="email" id="fname" value="<?php if(isset($_POST['email11'])) echo $_POST['email11']; ?>" name="email11" placeholder="Email" maxlength="30" required>
					<!--<br>-->
					<!--<label for="fname">Re-enter Email </label>-->
					<input type="email" id="fname" name="email22" value="<?php if(isset($_POST['email22'])) echo $_POST['email22']; ?>" placeholder="Re-enter Email" maxlength="30" required>
					<span class="error" >
					<font size="2"><?php if(isset($errors['email'])) echo $errors['email'];?></font></p>
					</span>
					<!--<label for="lname">Phone Number</label>-->
					<input type="number" id="lname" name="telphone" value="<?php if(isset($_POST['telphone'])) echo $_POST['telphone']; ?>" placeholder="Phone Number with Country Code"  required><br>
					<span class="error" >
