...
<body>
	<?php
	$firstNameErr = $lastNmeErr = $emailErr = $genderErr = $telErr = "";
	$firstName = $lastName = $email = $gender = $comment = $tel = "";
		...
		<article>
			...
			<div style="margin-right:50px;margin-left:50px">
				<form method="post" autocomplete="on" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
					...
					<input type="email" id="fname" name="email" placeholder="Email" maxlength="30" required>
					<!--<br>-->
					<!--<label for="fname">Re-enter Email </label>-->
					<input type="email" id="fname" name="reemail" placeholder="Re-enter Email" maxlength="30" required>
					<br>
					...
					<input type="password" id="fname" name="pass" placeholder="Password " min="5" max="20" required>
					<br>
					<!--<label for="fname">Re-type Password </label>-->
					<input type="password" id="fname" name="pass" placeholder="Re-type Password" min="5" max="20" required>
					<br>
